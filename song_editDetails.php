...
<body>
    ...
    ?>
                ...
                <form action="song_editSave.php" name="UpdateForm" method="POST">
                    ...
                    ?>
                        ...
                        <select name="Language" required>
                            ...
                            <option value="Malay" <?php if($PType == "Malay") echo "selected"; ?>>Malay</option>
                            ...
                            <option value="Thai" <?php if($PType == "Thai") echo "selected"; ?>>Thai</option>
        ...
        echo "No session exists or session has expired. Please log in";
    }
    ?>
